...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom" style="background-color: #222222; color:#22c414 ; border:none;"  >
          <div class="row">
            <div class="col-md-8 ">
              <div class="btn-group">
                <?php 
              ...
              ?>
                ...
                <div class="btn-group">
                  <form method="post" role="form" action="">
                    ...
                    <button type="submit" name="add_punch_in" class="btn btn-success btn-lg rounded" >Clock In</button>
                  </form>
          ...
          <center><h3 class="">Manage Atendance</h3>  </center>
          <div class="gap"></div>
                ...
                <tr>
                  ...
                  <td>
                    <form method="post" role="form" action="">
                      ...
                      <button type="submit" name="add_punch_out" class="btn btn-xs rounded" style="background-color: #ff0101;" >Clock Out</button>
                    </form>
                  </td>
                <?php } ?>
                <?php if($user_role == 1){ ?>
                 <td>
                  <a title="Delete" href="?delete_attendance=delete_attendance&aten_id=<?php echo $row['aten_id']; ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash" style="color: #22c414;"></span></a>
                </td>
              <?php } ?>
                </tr>
                <?php } ?>
